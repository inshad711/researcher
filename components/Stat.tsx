...
//           >
//             Our Impact in <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-purple-500">numbers</span>
//           </motion.h2>
      ...
      <div className="max-w-6xl mx-auto w-full">
        ...
        <div className="text-center mb-12 space-y-4">
          ...
          <motion.p
            ...
            className="text-[#364153] font-light max-w-xl mx-auto text-[16.36px] leading-[23px] tracking-[0.4px]"
          >
         We deliver market research and feasibility studies across Dubai and the UAE, helping businesses make confident, data-driven decisions backed by real insights.
          </motion.p>
        </div>
