...
//////////new
import React from 'react';
import { Play, BookOpen, User, Star, Dot, FileText, Globe } from 'lucide-react';
...
export default function ResearchSection() {
  return (
    <div className="bg-gray-50/30 pt-16 px-4 md:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-6">
          ...
          <div className="flex flex-col items-start md:items-end gap-4 max-w-sm">
            <p className=" md:text-right font-sans">
              Explore our latest peer-reviewed publications and deep-dive research projects tackling tomorrow's challenges.
            </p>
            <button className="bg-[#000000] text-white px-8 py-2 font-sans rounded-full transition-all shadow-lg shadow-blue-500/20">
              View All Papers
            </button>
          </div>
        </div>
