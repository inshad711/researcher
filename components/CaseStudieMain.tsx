  ...
  return (
    <div className="group flex flex-col md:flex-row w-full gap-4 md:gap-6 mb-16">
      ...
      <div className="w-full md:w-80 p-8 flex flex-col justify-between border border-gray-200  rounded-2xl bg-white transition-all duration-500 shadow-sm">
        ...
        {/* View Case Study Button */}
        <button className="mt-8 cursor-pointer group/btn flex items-center justify-between w-full px-5 py-4 bg-zinc-950  text-white  rounded-xl font-medium transition-all hover:bg-black  active:scale-[0.98]">
          <span className="text-sm">View Case Study</span>
          <ArrowRight
...
export default function CaseStudieMain() {
  ...
  const caseStudies: CaseStudyData[] = [
    ...
    },
    {
      ...
      year: "2023",
      image:
        "https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?auto=format&fit=crop&q=80&w=2400",
    },
  ];
    ...
    <div className="text-zinc-900">
      ...
      <header className="py-12 px-4 max-w-7xl mx-auto text-center">
        ...
        <p className="font-sans max-w-xl mx-auto">
          A selection of digital experiences and brand narratives crafted with
          precision.
        </p>
      </header>
